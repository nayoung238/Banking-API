...
class AccountServiceTest {
    ...
    void setUp() {
        ...
        createAccountRequest.setCurrency(Currency.대한민국);

        user = new Users("테스트이름", "test1234", "1234");
    }
    ...
    void createAccount() {
        ...
        // given
        when(usersRepository.findById(eq(1L))).thenReturn(Optional.ofNullable(user));
