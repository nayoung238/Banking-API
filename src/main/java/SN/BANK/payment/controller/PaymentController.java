...
public class PaymentController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200",description = "결제 내역 조회 완료",content = @Content(schema = @Schema(implementation = PaymentListResponseDto.class)))
            ,@ApiResponse(responseCode = "404",description = "결제내역이 존재하지 않습니다.",content = @Content(schema = @Schema(implementation = String.class)))
    })
